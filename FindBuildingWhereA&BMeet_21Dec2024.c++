...
//             if(heights[max(queries[i][1],queries[i][0])]>heights[min(queries[i][1],queries[i][0])]){
//                 ans.push_back(max(queries[i][1],queries[i][0]));
//             }
...
//                 for(int j=max(queries[i][0],queries[i][1]);j<heights.size();j++){
//                     if(heights[j]>maxi){
//                         ans.push_back(j);
//                         found=true;
//                         break;
